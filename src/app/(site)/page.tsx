  ...
  return (
    <>
      <section className="gap-4 px-4 mt-10 overflow-hidden sm:px-6 sm:flex sm:flex-col md:justify-center md:items-center">
        ...
        />
        <div className="bg-white p-[2px] mt-6 rounded-xl bg-gradient-to- from-primary to-brand-primaryBlue sm:w-[300px]">
          <Button
            variant="secondary"
      ...
      <section className="relative">
        ...
        <div className="flex flex-col px-4 mt-20 overflow-visible overflow-x-hidden sm:px-6">
          <TitleSection
